...
export default class HigherOrderComponent extends Component {
    ...
    renderItems = () => {
        ...
        const mapRows = data.map((item) => ( <
            ...
            <
            li className = "list-elements" > { /* Passing unique value to 'key' prop, eases process for virtual DOM to remove specific element and update HTML tree  */ } <
                                    ...
                                    const mapRows = data.filter(item => item.age > 28 && item.age <= 50).map(item => ( < React.Fragment key = { item.id } >
                                        ...
                                        render() {
                                            return ( <
                                                ...
                                                React.Fragment >
                                                <
                                                h1 > Display based on usertType < /h1> <
                                                div className = "display-box" >
                                                <
